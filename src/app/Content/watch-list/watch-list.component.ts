...
EventSourceApi() {
  ...
  //       this.model2 = responseData.data as SuggestionViewModel[];
  //       this.trendingList = this.model2.map(
  //         function (item) {
  //           return { value: item.symbols, id: item.id, label: item.companyName, changePercent: item.changePercent ? item.changePercent : 0 };
  //         });
  //     }
  //   }
  //   );
  ...
  saveFeedback() {
    ...
    this.base.post(AppSetting.feebackCreate, feedback).subscribe(() => {
